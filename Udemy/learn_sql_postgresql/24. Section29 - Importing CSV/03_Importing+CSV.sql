...
FROM '/Users/oscarsantamaria/git/personal/trainingnotes/Udemy/janeiro-courses/learn_sql_postgresql/24. Section29 - Importing CSV/import files/navaids.csv' 
...
\copy regions (id,code, local_code, name, continent, iso_country, wikipedia_link, keywords) 
FROM '/Users/oscarsantamaria/git/personal/trainingnotes/Udemy/janeiro-courses/learn_sql_postgresql/24. Section29 - Importing CSV/import files/regions.csv' 
DELIMITER ',' CSV HEADER;
...
FROM '/Users/oscarsantamaria/git/personal/trainingnotes/Udemy/janeiro-courses/learn_sql_postgresql/24. Section29 - Importing CSV/import files/countries.csv' 
DELIMITER ',' CSV HEADER;
...
FROM '/Users/oscarsantamaria/git/personal/trainingnotes/Udemy/janeiro-courses/learn_sql_postgresql/24. Section29 - Importing CSV/import files/runways.csv' 
DELIMITER ',' CSV HEADER;
